...
class SMTPSocketStage(IVerificationStage):
    ...
    def __init__(
        ...
        self.helo_domain = helo_domain or os.getenv("SMTP_HELO_DOMAIN", "verifier.yourdomain.com")
        self.from_email = from_email or os.getenv("SMTP_MAIL_FROM", f"verify@{self.helo_domain.replace('verifier.', '')}")
